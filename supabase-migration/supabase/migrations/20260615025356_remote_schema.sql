...
ALTER TABLE "public"."checkpoint_images" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."checkpoint_reactions" (
    "checkpoint_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."checkpoint_reactions" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."checkpoints" (
    ...
    CONSTRAINT "checkpoints_rating_check" CHECK ((("rating" >= 1) AND ("rating" <= 5)))
);
...
ALTER TABLE ONLY "public"."checkpoint_images"
    ADD CONSTRAINT "checkpoint_images_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."checkpoint_reactions"
    ADD CONSTRAINT "checkpoint_reactions_pkey" PRIMARY KEY ("checkpoint_id", "user_id");
...
CREATE INDEX "idx_checkpoint_images_cp" ON "public"."checkpoint_images" USING "btree" ("checkpoint_id");



CREATE INDEX "idx_checkpoint_reactions_cp" ON "public"."checkpoint_reactions" USING "btree" ("checkpoint_id");



CREATE INDEX "idx_checkpoints_created" ON "public"."checkpoints" USING "btree" ("created_at" DESC);



CREATE INDEX "idx_checkpoints_journey" ON "public"."checkpoints" USING "btree" ("journey_id");
...
CREATE INDEX "idx_checkpoints_place" ON "public"."checkpoints" USING "btree" ("place_id");



CREATE INDEX "idx_checkpoints_province" ON "public"."checkpoints" USING "btree" ("user_id", "province") WHERE (("deleted_at" IS NULL) AND ("province" IS NOT NULL));



CREATE INDEX "idx_checkpoints_user" ON "public"."checkpoints" USING "btree" ("user_id") WHERE ("deleted_at" IS NULL);
...
CREATE INDEX "idx_journeys_active" ON "public"."journeys" USING "btree" ("user_id", "updated_at" DESC) WHERE ("is_active" AND ("deleted_at" IS NULL));



CREATE INDEX "idx_journeys_user" ON "public"."journeys" USING "btree" ("user_id") WHERE ("deleted_at" IS NULL);



CREATE INDEX "idx_places_checkin_count" ON "public"."places" USING "btree" ("checkin_count" DESC);
...
ALTER TABLE ONLY "public"."checkpoint_images"
    ADD CONSTRAINT "checkpoint_images_checkpoint_id_fkey" FOREIGN KEY ("checkpoint_id") REFERENCES "public"."checkpoints"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."checkpoint_reactions"
    ADD CONSTRAINT "checkpoint_reactions_checkpoint_id_fkey" FOREIGN KEY ("checkpoint_id") REFERENCES "public"."checkpoints"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."checkpoint_reactions"
    ADD CONSTRAINT "checkpoint_reactions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."checkpoints"
    ADD CONSTRAINT "checkpoints_journey_id_fkey" FOREIGN KEY ("journey_id") REFERENCES "public"."journeys"("id");



ALTER TABLE ONLY "public"."checkpoints"
    ADD CONSTRAINT "checkpoints_place_id_fkey" FOREIGN KEY ("place_id") REFERENCES "public"."places"("id");
...
ALTER TABLE ONLY "public"."journeys"
    ADD CONSTRAINT "journeys_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;
...
GRANT ALL ON TABLE "public"."checkpoint_images" TO "anon";
GRANT ALL ON TABLE "public"."checkpoint_images" TO "authenticated";
GRANT ALL ON TABLE "public"."checkpoint_images" TO "service_role";



GRANT ALL ON TABLE "public"."checkpoint_reactions" TO "anon";
GRANT ALL ON TABLE "public"."checkpoint_reactions" TO "authenticated";
GRANT ALL ON TABLE "public"."checkpoint_reactions" TO "service_role";
